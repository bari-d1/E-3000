...
router.get("/sessions/new", requireAuth, (req, res) => {
  res.render("sessions/new", { title: "New Session", errors: null, values: {} });
});
 ...
 */
router.post("/sessions", requireSubmit,  validateBody(SessionSchema, { view: "sessions/new", title: "New Session" }), async (req, res) => {
  try {
